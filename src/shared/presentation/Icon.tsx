/**
 * Material Symbols icon primitive.
 *
 * Renders monochrome SVG icons that inherit `color` via `fill="currentColor"`,
 * so they recolour automatically with the surrounding button/text token
 * (`--fg`, `--fg-muted`, etc.). 24×24 source viewBox; pass `size` for the
 * rendered px box.
 *
 * Path data is the official Material Icons (filled) set. Add entries to
 * `ICON_PATHS` as needed — keep the key names semantic (action, not glyph).
 */
...
export const ICON_PATHS = {
  ...
  // Toolbar actions
  // verticalSplit — Material Symbols 'vertical_split'. Two side-by-side
  // panels with a divider; reads instantly as "split view".
  verticalSplit:
    "M3 15h6V5H3v10zm0 4h18v-2H3v2zM11 15h10V5H11v10z",
  // share — Material Symbols 'share'. Three nodes connected — the
  // standard "share to..." metaphor across iOS/Android/web.
  share:
    "M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92 1.61 0 2.92-1.31 2.92-2.92s-1.31-2.92-2.92-2.92z",
  // download — Material Symbols 'file_download'. Arrow into tray —
  // the universal "save to disk / export" affordance.
  download:
    "M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z",
  // chevronDown — small caret for "this is a menu" hint on icon buttons.
  chevronDown:
...
interface IconProps {
  name: IconName;
  /** Rendered px box (width = height). Default 16. */
  size?: number;
  style?: CSSProperties;
  className?: string;
}

export function Icon({ name, size = 16, style, className }: IconProps): React.JSX.Element {
  return (
    <svg
      width={size}
      height={size}
