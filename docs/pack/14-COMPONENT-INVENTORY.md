...
covers: [component-ids, C001-C124, component-props, component-boundaries]
---

# 14. Component inventory

**One row per component, 124 rows.** Sixty exist in the code at `0af3c90`. Sixty-four are named by
the screens and have never been built.
...
C004 | VaultWorkspace | app-shell | composition | exists | S04
...
C008 | SearchPanel | app-shell | composition | exists | S04
...
C021 | SgnkAiButton | ai-tools | primitive | exists | S06
...
C025 | EditorPane | editor | composition | exists | S04, S05
C026 | CodeMirrorEditor | editor | composition | exists | S04
...
C034 | Markdown | preview | composition | exists | S04, S08, S18
C035 | RightPane | preview | composition | exists | S04
...
C063 | Chip | shared | primitive | implied by screens, not built | S06, S12, S22
C064 | Pill | shared | primitive | implied by screens, not built | S03, S04, S11, S29
C065 | Segment | shared | primitive | implied by screens, not built | S04, S05, S09
C066 | Modal | shared | primitive | implied by screens, not built | S17, S21, S22, S28
...
C069 | Card | shared | primitive | implied by screens, not built | S02, S25, S29
C070 | Avatar | shared | primitive | implied by screens, not built | S19, S20, S21
C071 | BrandMark | shared | primitive | implied by screens, not built | S01, S18, S30
C072 | Switch | shared | primitive | implied by screens, not built | S28, S37
C073 | Meter | shared | primitive | implied by screens, not built | S29, S36
C074 | ProgressBar | shared | primitive | implied by screens, not built | S22
C075 | Banner | shared | primitive | implied by screens, not built | S24, S33
C076 | TopBar | app-shell | composition | implied by screens, not built | every screen
C077 | ModeBar | editor | composition | implied by screens, not built | S04, S05
C078 | TabStrip | editor | composition | implied by screens, not built | S04
...
C082 | FilterSegment | shared | primitive | implied by screens, not built | S10, S20
C083 | LeftRail | vault | composition | implied by screens, not built | S04, S12
C084 | RailSection | preview | composition | implied by screens, not built | S04
C085 | DropHint | vault | primitive | implied by screens, not built | S02, S04, S22, S34
...
C090 | RecentList | unassigned | composition | implied by screens, not built | S03
...
C093 | InlineSuggestion | editor | composition | implied by screens, not built | S07
...
C104 | IdeaList | unassigned | composition | implied by screens, not built | S12
...
C109 | SkipAllModal | unassigned | composition | implied by screens, not built | S13
C110 | DecisionCard | unassigned | composition | implied by screens, not built | S14
C111 | KitFileList | unassigned | composition | implied by screens, not built | S15, S34
...
C115 | LinkBox | share | composition | implied by screens, not built | S17
...
C119 | ChangeQueue | unassigned | composition | implied by screens, not built | S20
...
C123 | PlanCards | unassigned | composition | implied by screens, not built | S29
...
C076 | `tabs: Tab[]`, `share: boolean`, `presence?: Presence[]`, `extra?: ReactNode` | workspace, published page | resting, scrolled | A banner landmark | Never on the phone unchanged. The phone header is 52 px and carries the mode segment
...
C083 | `projects: Project[]`, `ideasOpen: boolean` | none | loading, tree, empty, drop target | A navigation landmark holding `C052` | Never with a third button. Add file and Add idea, and nothing else
...
C124 | `rows: ConfigRow[]`, `locked: string[]` | limits, models, flags, accounts | reading, editing, saving, refused | Every cell is a labelled field, and a locked row states why | **Never reachable without a founder role.** It sets every limit for every account
...
Total | **124**
`exists` | **60**
`implied by screens, not built` | **64**
`primitive` | **45**
`composition` | **79**

**Re-derive** with
`grep -cE '^\`C[0-9]{3}\` \| .* \| (exists\|implied by screens, not built) \| ' docs/pack/14-COMPONENT-INVENTORY.md`
and by swapping the last group for `(primitive|composition)`.
...
indicator. **Those are drawing furniture, not product**, and `C086` says so.
...
- **Could not be verified:** the `states` column for the 64 unbuilt components. Those are read from
...
- **Not established:** the module for 22 components marked `unassigned`. They belong to features that
...
- **What would falsify the count of 64 implied:** a different reading of `gen.mjs`. The mapping from
  283 classes to 64 components is a judgement made once, in this session, and another reader would
