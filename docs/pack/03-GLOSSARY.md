...
Splice journal | Not a general term | The record of splices that, with git-merge and CAS, is how sync works in place of a CRDT. Specified since 18 September in `67-SYNC-AND-CONFLICT.md` section 2 and `adr/ADR-0003-sync-without-crdt.md`; still in no file under `specs/` (`grep -rl -i 'splice journal' specs/` finds nothing, checked 2026-09-18) | `67-SYNC-AND-CONFLICT.md`
