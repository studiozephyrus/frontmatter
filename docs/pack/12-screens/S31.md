...
> digits after the letter as the screen number, so this file reserves `C310` to `C319`, `E310` to
> `E319` and `A310` to `A319`. Copy ids are namespaced `K.s31.*`. Decision ids across S27 to S38
