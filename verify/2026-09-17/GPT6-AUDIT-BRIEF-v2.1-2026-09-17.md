# Audit brief v2.1 for GPT 6: the frontmatter product plan, every angle, at full depth

This brief replaces `GPT6-VERIFY-PROMPT.md` and `GPT6-AUDIT-BRIEF-v2-2026-09-17.md` in this folder. That one was a verification brief. This one is a full audit. It is longer because the founders asked for the deepest level of check there is: every claim, every decision, every screen, every number, every legal and technical angle, the research itself, and the process that produced the plan. Nothing in the plan is exempt, including the parts that say they were verified.
